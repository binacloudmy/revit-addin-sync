...
namespace RevitWebAppSync.Services
{
    ...
    public static class ToolLabels
    {
        ...
        private static readonly Dictionary<string, string> Map = new Dictionary<string, string>
        {
            ...
            ["fill_missing_parameter"]     = "Filling empty parameters",
            ["propagate_parameter_by_name"] = "Propagating parameter values",
            ["set_type_parameter"]         = "Editing type parameters",
            ["duplicate_sheet"]            = "Duplicating sheet",
            ["create_sheets_batch"]        = "Creating sheets",
            ["create_views_for_levels"]    = "Creating views per level",
            ["align_viewports"]            = "Aligning viewports",
            ["create_revision"]            = "Creating revision",
            ["set_revision_on_sheets"]     = "Stamping revisions on sheets",
            ["set_workset_bulk"]           = "Moving elements to workset",
            ["fix_warnings"]               = "Fixing warnings",
            ["apply_parameter_import"]     = "Importing parameters from Excel",
            ["select_by_filter"]           = "Selecting by filter",
            ["reset_temporary_hide"]       = "Resetting temporary hide",
            ["export_parameters_to_excel"] = "Exporting parameters to Excel",
