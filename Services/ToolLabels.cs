...
namespace RevitWebAppSync.Services
{
    ...
    public static class ToolLabels
    {
        ...
        private static readonly Dictionary<string, string> Map = new Dictionary<string, string>
        {
            ...
            ["create_duct"]                = "Creating duct runs",
            ["create_pipe"]                = "Creating pipe runs",
            ["create_conduit"]             = "Creating conduit runs",
            ...
            ["suggest_lighting_points"]    = "Planning lighting layout",
            ["suggest_circuits"]           = "Proposing electrical circuits",
            ["create_circuits"]            = "Creating electrical circuits",
            ["list_circuits"]              = "Reading existing circuits",
            ["remove_from_circuit"]        = "Removing devices from circuits",
            ["suggest_circuit_routes"]     = "Planning wire and conduit routes",
            ["create_circuit_routes"]      = "Creating wires and conduits",
            ["validate_panel_schedule"]    = "Validating the panel schedule",
            ["check_circuit_loads"]        = "Checking circuit loads",
            ["check_code_compliance"]      = "Checking code compliance",
            ["list_electrical_settings"]   = "Reading electrical settings",
            ["set_distribution_system"]    = "Assigning the distribution system",
            ["set_connector_electrical_data"] = "Fixing family connector data",
            ["create_distribution_system"] = "Creating the distribution system",
            ["edit_distribution_system"]   = "Updating the distribution system",
            ["check_corridor"]             = "Checking route clearance",
            ["trace_mep_connections"]      = "Tracing MEP connections",
            ["place_socket_points"]        = "Placing sockets",
            ["place_lighting_points"]      = "Placing lighting fixtures",
