...
namespace RevitWebAppSync.UI.Copilot.Model
{
    ...
    public static class ToolCatalog
    {
        ...
        public static readonly IReadOnlyList<SlashTool> All = new List<SlashTool>
        {
            ...
            // Massing / space planning. Handled ENTIRELY in-addin (POST
            // /planning/suggest + the Planning screen), so it is deliberately NOT
            // in _backendIds — it never goes through the shared RouteAsync path.
            // "/planning" finds it too: the palette matches on Keywords.
            new SlashTool { Id="massing",      Category="Architecture",  Name="Massing / Space Planning", Subtitle="Brief → SOA + block schemes → Revit group", Badge=ToolBadge.AiAssisted, IconKey="ti-layout-grid",    Keywords="massing planning soa gfa school layout blok sekolah bilik darjah tandas ubbl jkr space program schedule accommodation temflex lod100" },
