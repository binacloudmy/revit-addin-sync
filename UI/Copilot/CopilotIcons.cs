...
namespace RevitWebAppSync.UI.Copilot
{
    ...
    public static class CopilotIcons
    {
        ...
        public static readonly Dictionary<string, string> Paths = new Dictionary<string, string>
        {
            ...
            ["thumbUp"]     = "M7,22 H4 a1,1 0 0 1 -1,-1 V12 a1,1 0 0 1 1,-1 h3 M7,11 v11 M7,11 l4,-9 a2,2 0 0 1 3,1.7 V8 h5 a2,2 0 0 1 2,2.3 l-1.3,8 a2,2 0 0 1 -2,1.7 H7",
            ["thumbDown"]   = "M17,2 h3 a1,1 0 0 1 1,1 v9 a1,1 0 0 1 -1,1 h-3 M17,13 V2 M17,13 l-4,9 a2,2 0 0 1 -3,-1.7 V16 H5 a2,2 0 0 1 -2,-2.3 l1.3,-8 a2,2 0 0 1 2,-1.7 H17",
        };
