    ...
    public class BinaApiService
    {
        ...
        public static async Task<LoginResponse> LoginWithCredentialsAsync(string email, string password)
        {
            try
            {
                ...
                var response = await httpClient.PostAsync("https://api-stg.bina.cloud/api/auth/user/sign-in", content);
        ...
        public static async Task<System.Collections.Generic.List<ProjectInfo>> GetUserProjectsAsync(string accessToken)
        {
            try
            {
                ...
                var response = await httpClient.GetAsync("https://api-stg.bina.cloud/api/cloud-docs/bim-discipline/user/projects");
            ...
            string disciplineType = null)
        {
            try
            {
                ...
                string url = $"https://api-stg.bina.cloud/api/cloud-docs/bim-discipline/project/{projectId}/wip-folders";
