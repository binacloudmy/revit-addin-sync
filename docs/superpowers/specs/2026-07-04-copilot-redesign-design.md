...
- **Warnings** (composer visible): ≥80% dismissible banner, ≥95% persistent banner (copy: "{pctLeft}% left" pattern from design screenshots; exact banner markup not in this file — match meter ramp colors, hairline card).
